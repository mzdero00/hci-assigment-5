  ...
  return (
    ...
    >
      <div className="max-w-screen-lg w-full space-y-10 py-10">
        ...
        <section className="flex flex-col md:flex-row-reverse items-center gap-8 bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="flex-1 space-y-6 mb-12 md:mb-0">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              Since 2019, we’ve built a strong reputation for trust and customer
              satisfaction.
            </p>
          </div>
        </section>
        ...
        {/* CTA Section */}
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-white p-8 rounded-lg shadow-lg">
